  ...
  return (
    <section id="contact" className="mb-20 backdrop-blur-sm bg-white/80 dark:bg-black/50 p-6 rounded-lg shadow-lg">
      ...
      <div className="flex flex-col space-y-4">
        ...
        <a href="https://linkedin.com/in/yourusername" className="flex items-center space-x-2 text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
        ...
        <a href="https://github.com/yourusername" className="flex items-center space-x-2 text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
